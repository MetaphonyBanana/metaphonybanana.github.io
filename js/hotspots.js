...
const HOTSPOTS = [
  ...
  { pos: [-350, -230, 10],  text: ['Go home and get your bike and meet me in front of Bobby\'s house. Hurry up.',
                                    'Allie had this left-handed fielder’s mitt.\nHe was left-handed.','He never got sore about anything'
  ] },
  //Y
  { pos: [40, -200, -150],  text: ['That was a secret bugle only admiral to hear.\n—Boo Boo Glass'] },
  { pos: [200, -100, -260],  text: ['gift horse\n─Teddy',
                                   'triumvirate\n─Teddy'
  ] },
  { pos: [-100, -180, -150],  text: ['Did the tigers run all around that tree?\n─Sybil Carpenter',
                                 'Here comes a wave.\n─Sybil Carpenter']
   },
  { pos: [-10, -170, -150],  text: ['What did one wall say to the other wall?\n—For Esmé','He was rather like a christmas tree whose lights, wired in series, must all go out if even one bulb is defective.\n—For Esmé',
