...
const HOTSPOTS = [
   //X
  { pos: [-20, -80, 100],  text: ['It\’s rainning.\nIt\’s starting to rain.','Aren\’t you gonna ride too?'] },
  { pos: [-80, -130, 100],  text: ['This is a people shooting hat.',
                                  'Mine came from Mark Cross.']
   },
  { pos: [-450, -330, 50],  text: ['Go home and get your bike and meet me in front of Bobby\’s house. Hurry up.',
                                    'But twice ─ twice ─ we were there it started to rain.','He never got sore about anything'
  ] },
  //Y
  { pos: [120, -200, -150],  text: ['That was a secret bugle only Admirals to hear.\n—Boo Boo Glass'] },
  { pos: [200, -100, -260],  text: ['gift horse\n─Teddy',
                                   'triumvirate\n─Teddy'
  ] },
  { pos: [-40, -150, -100],  text: ['Did the tigers run all around that tree?\n─Sybil Carpenter',
                                 'Here comes a wave.\n─Sybil Carpenter']
   },
  { pos: [-30, -100, -60],  text: ['What did one wall say to the other wall?\n—For Esmé','He was rather like a christmas tree whose lights, wired in series, must all go out if even one bulb is defective.\n—For Esmé',
'The door banged open without having been wrapped on. X raised his head, turned it, and corporal Z standing in the door.\n—For Esmé'] },
  //Z
  { pos: [-200,10, -150], text: ['I want to talk to Seymour.\n─Franny Glass','The only kind of chicken soup Bessie ever brings to anybody around this madhouse.\n─Zooey Glass'] },
  { pos: [-70, 30, -190], text: ['I was Mercury himself.\n─Buddy Glass',
                                 'This which, I suggest, though possibly not to everyone’s taste, is highly literate vaudeville.\n─Buddy Glass'
  ] },
  { pos: [-100, 150, -140],   text: ['Keep me up till five only because all your stars are out, and for other reason.\n─Seymour Glass','All we do our whole lives is go from one little piece of Holy Ground to the next.\n─Seymour Glass',
