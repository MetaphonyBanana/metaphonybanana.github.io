...
const DIALOGUE_STARS = [
  ...
  { texts: ['Pool. I\’ll have to discuss another time.It wasn\’t just a game with us, it was almost a Protestant Reformation.\n—Buddy', 'We shot pool before or after almost every important crisis of our young manhood.\n—Buddy '], color: '#a3a3a3', orbitRadius: 4.5,  orbitSpeed: 0.30, tilt: 0.10 },
  { texts: ['The Ocean Full of Bowling Balls'], color: '#e7cf9e', orbitRadius: 6.5,  orbitSpeed: 0.23, tilt: 0.16 },
  { texts: ['opened a heavy metal door that read:\nTO THE POOL.\n—Teddy', 'A man walks along the beach and unfortunately gets hit in the head by a cocoanut.\n—Teddy'], color: '#4f92d6', orbitRadius: 8.6,  orbitSpeed: 0.18, tilt: 0.20 },
  { texts: ['But if you get on the other side, where there aren\’t any hot-shots, then what\’s a game about it?\n—Holden','Life is a game'],                        color: '#d18d78', orbitRadius: 10.6, orbitSpeed: 0.14, tilt: 0.14 },
  { texts: ['He would be all smiles when he heard a responsive click of glass striking glass\n—Buddy', 'It never appeared to be clear to him whose winning click it was.\n—Buddy'], color: '#e0c073', orbitRadius: 12.8, orbitSpeed: 0.10, tilt: 0.24 },
  { texts: ['One of us will be present at the other chap\’s departure for various reasons.\n—Seymour'], color: '#8d1b63', orbitRadius: 12.8, orbitSpeed: 0.10, tilt: 0.24 },
];
